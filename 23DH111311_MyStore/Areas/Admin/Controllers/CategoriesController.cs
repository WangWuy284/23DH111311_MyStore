...
using _23DH111311_MyStore.Models;

namespace _23DH111311_MyStore.Areas.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest); //mã lối 400: thiếu giá trị truyền vào
            }
        ...
        // POST: lưu dữ liệu nhâp vào từ form Create vào DB
